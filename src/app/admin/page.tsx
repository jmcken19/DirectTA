            ...
            <div className="grid gap-8 lg:grid-cols-2">
                ...
                <BaseGlassCard delay={0.3} className="lg:col-span-2 flex flex-col gap-6">
                    <div className="border-b border-white/10 pb-4 flex items-center gap-3">
                        ...
                        <span className="ml-2 rounded-full bg-white px-2 py-0.5 text-xs font-bold text-black">2 Pending</span>
                    </div>
                    ...
                    <div className="rounded-xl border border-white/20 bg-black p-6">
                        <div className="mb-4">
                            ...
                            <p className="text-sm text-gray-400 mt-1">Generated from 6 identical student queries</p>
                        </div>
                    ...
                    <div className="rounded-xl border border-white/20 bg-black p-6 opacity-60">
                        <div className="mb-4">
                            <h3 className="font-bold text-white text-lg">Auto-Summarized: Final Project Groups</h3>
                            <p className="text-sm text-gray-400 mt-1">Generated from 4 identical student queries</p>
                        </div>
                        ...
                        <div className="grid gap-4 md:grid-cols-2 mb-6">
                            ...
                            <div className="rounded border border-white/10 bg-white/5 p-4">
                                <span className="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-2 block">AI Fix Summary</span>
                                <p className="text-sm text-white">Yes, teams of up to 2 are allowed. Both members must submit the report, but only one uploads the codebase.</p>
                            </div>
                        </div>
